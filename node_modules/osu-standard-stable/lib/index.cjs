...
class StandardNoMod extends osuClasses.NoMod {
}

class StandardNoFail extends osuClasses.NoFail {
}

class StandardEasy extends osuClasses.Easy {
}
...
class StandardTouchDevice {
  constructor() {
    ...
    this.acronym = 'TD';
    this.bitwise = osuClasses.ModBitwise.TouchDevice;
    this.type = osuClasses.ModType.System;
    this.multiplier = 1;
    this.isRanked = true;
...
class StandardHidden extends osuClasses.Hidden {
...
class StandardHitWindows extends osuClasses.HitWindows {
  isHitResultAllowed(result) {
    switch (result) {
      case osuClasses.HitResult.Great:
      case osuClasses.HitResult.Ok:
      case osuClasses.HitResult.Meh:
      case osuClasses.HitResult.Miss:
        return true;
    }
...
StandardHitWindows.OSU_RANGES = [
  new osuClasses.DifficultyRange(osuClasses.HitResult.Great, 80, 50, 20),
  new osuClasses.DifficultyRange(osuClasses.HitResult.Ok, 140, 100, 60),
  new osuClasses.DifficultyRange(osuClasses.HitResult.Meh, 200, 150, 100),
  new osuClasses.DifficultyRange(osuClasses.HitResult.Miss, 400, 400, 400),
];

class StandardHitObject extends osuClasses.HitObject {
  constructor() {
    super(...arguments);
    ...
    this._scale = 0.5;
    this._stackHeight = 0;
    this._stackOffset = new osuClasses.Vector2(0, 0);
...
class StandardEventGenerator extends osuClasses.EventGenerator {
  static *generateSliderTicks(slider) {
    for (const event of osuClasses.EventGenerator.generate(slider)) {
      ...
      switch (event.eventType) {
        ...
        case osuClasses.SliderEventType.LegacyLastTick: {
...
class Slider extends StandardHitObject {
  constructor() {
    ...
    this.nodeSamples = [];
    this.repeats = 0;
    this.startPosition = new osuClasses.Vector2(0, 0);
  }
  get startX() {
...
class Spinner extends StandardHitObject {
  ...
  applyDefaultsToSelf(controlPoints, difficulty) {
    ...
    const minimumRotations = Spinner.STABLE_MATCHING_FUDGE
            * osuClasses.BeatmapDifficultySection.range(difficulty.overallDifficulty, 3, 5, 7.5);
...
class StandardHardRock extends osuClasses.HardRock {
...
StandardHardRock.BASE_SIZE = new osuClasses.Vector2(512, 384);

class StandardSuddenDeath extends osuClasses.SuddenDeath {
}

class StandardDoubleTime extends osuClasses.DoubleTime {
}

class StandardRelax extends osuClasses.Relax {
}

class StandardHalfTime extends osuClasses.HalfTime {
}

class StandardNightcore extends osuClasses.Nightcore {
}

class StandardFlashlight extends osuClasses.Flashlight {
}

class StandardAutoplay extends osuClasses.Autoplay {
}
...
class StandardSpunOut {
  constructor() {
    this.name = 'Spun Out';
    this.acronym = 'SO';
    this.bitwise = osuClasses.ModBitwise.SpunOut;
    this.type = osuClasses.ModType.Automation;
    this.multiplier = 0.9;
    this.isRanked = true;
    this.incompatibles = osuClasses.ModBitwise.Autoplay |
            osuClasses.ModBitwise.Cinema |
            osuClasses.ModBitwise.Relax2;
  }
}
...
class StandardAutopilot {
  constructor() {
    this.name = 'Autopilot';
    this.acronym = 'AP';
    this.bitwise = osuClasses.ModBitwise.Relax2;
    this.type = osuClasses.ModType.Automation;
    this.multiplier = 1;
    this.isRanked = false;
    this.incompatibles = osuClasses.ModBitwise.NoFail |
            osuClasses.ModBitwise.SuddenDeath |
            osuClasses.ModBitwise.Perfect |
            osuClasses.ModBitwise.Autoplay |
            osuClasses.ModBitwise.Cinema |
            osuClasses.ModBitwise.Relax |
            osuClasses.ModBitwise.SpunOut;
  }
}

class StandardPerfect extends osuClasses.Perfect {
}

class StandardCinema extends osuClasses.Cinema {
}

class StandardModCombination extends osuClasses.ModCombination {
  get mode() {
    return 0;
  }
  get _availableMods() {
...
class StandardBeatmap extends osuClasses.RulesetBeatmap {
  constructor() {
    super(...arguments);
...
class StandardBeatmapConverter extends osuClasses.BeatmapConverter {
  canConvert(beatmap) {
  ...
  *convertHitObjects(beatmap) {
  ...
  _copyProperties(converted, obj) {
    ...
    converted.startPosition = (_a = posObj === null || posObj === void 0 ? void 0 : posObj.startPosition) !== null && _a !== void 0 ? _a : new osuClasses.Vector2(0, 0);
...
class StandardBeatmapProcessor extends osuClasses.BeatmapProcessor {
  postProcess(beatmap) {
...
class StandardDifficultyAttributes extends osuClasses.DifficultyAttributes {
  constructor() {
    super(...arguments);
...
class StandardPerformanceAttributes extends osuClasses.PerformanceAttributes {
...
class StandardDifficultyHitObject extends osuClasses.DifficultyHitObject {
  constructor(hitObject, lastObject, lastLastObject, clockRate, objects, index) {
    ...
    this.hitWindowGreat = this.baseObject instanceof Slider && this.baseObject.head
      ? 2 * this.baseObject.head.hitWindows.windowFor(osuClasses.HitResult.Great) / clockRate
      : 2 * this.baseObject.hitWindows.windowFor(osuClasses.HitResult.Great) / clockRate;
  ...
  opacityAt(time, hidden) {
    ...
    if (hidden) {
      ...
      return Math.min(osuClasses.MathUtils.clamp((time - fadeInStartTime) / fadeInDuration, 0, 1), 1.0 - osuClasses.MathUtils.clamp((time - fadeOutStartTime) / fadeOutDuration, 0, 1));
    }

    return osuClasses.MathUtils.clamp((time - fadeInStartTime) / fadeInDuration, 0, 1);
  }
  _setDistances(clockRate) {
    ...
    if (lastObj instanceof Slider) {
      ...
      this.minimumJumpDistance = osuClasses.MathUtils.clamp(this.lazyJumpDistance - (maxSliderRadius - assumedSliderRadius), 0, Math.fround(tailJumpDistance - maxSliderRadius));
    }
...
class StandardStrainSkill extends osuClasses.StrainSkill {
  constructor() {
    super(...arguments);
  ...
  get difficultyValue() {
    ...
    for (let i = 0; i < length; ++i) {
      ...
      const clamp = osuClasses.MathUtils.clamp01(value);
...
class SpeedEvaluator {
  static evaluateDifficultyOf(current) {
    ...
    strainTime /= osuClasses.MathUtils.clamp((strainTime / osuCurrObj.hitWindowGreat) / 0.93, 0.92, 1);
...
class Flashlight extends osuClasses.StrainSkill {
  constructor(mods) {
    super(mods);
    this._currentStrain = 0;
...
class StandardPerformanceCalculator extends osuClasses.PerformanceCalculator {
  ...
  _computeAimValue(attributes) {
    ...
    if (attributes.sliderCount > 0) {
      ...
      const estimateSliderEndsDropped = osuClasses.MathUtils.clamp(min, 0, estimateDifficultSliders);
  ...
  _addParams(attributes, score) {
    ...
    if (score) {
      ...
      this._countGreat = (_c = score.statistics.get(osuClasses.HitResult.Great)) !== null && _c !== void 0 ? _c : this._countGreat;
      this._countOk = (_d = score.statistics.get(osuClasses.HitResult.Ok)) !== null && _d !== void 0 ? _d : this._countOk;
      this._countMeh = (_e = score.statistics.get(osuClasses.HitResult.Meh)) !== null && _e !== void 0 ? _e : this._countMeh;
      this._countMiss = (_f = score.statistics.get(osuClasses.HitResult.Miss)) !== null && _f !== void 0 ? _f : this._countMiss;
...
class StandardDifficultyCalculator extends osuClasses.DifficultyCalculator {
  constructor() {
    super(...arguments);
  ...
  _createDifficultyAttributes(beatmap, mods, skills, clockRate) {
    ...
    const hitWindowGreat = hitWindows.windowFor(osuClasses.HitResult.Great) / clockRate;
...
})(exports.StandardAction || (exports.StandardAction = {}));

class StandardReplayFrame extends osuClasses.ReplayFrame {
  constructor() {
    super(...arguments);
    this.position = new osuClasses.Vector2(0, 0);
  ...
  fromLegacy(currentFrame) {
    ...
    if (currentFrame.mouseLeft) {
      this.actions.add(exports.StandardAction.LeftButton);
    }

    if (currentFrame.mouseRight) {
      this.actions.add(exports.StandardAction.RightButton);
    }

    if (currentFrame.smoke) {
      this.actions.add(exports.StandardAction.Smoke);
    }
  ...
  toLegacy() {
    ...
    if (this.actions.has(exports.StandardAction.LeftButton)) {
      state |= osuClasses.ReplayButtonState.Left1;
    }

    if (this.actions.has(exports.StandardAction.RightButton)) {
      state |= osuClasses.ReplayButtonState.Right1;
    }

    if (this.actions.has(exports.StandardAction.Smoke)) {
      state |= osuClasses.ReplayButtonState.Smoke;
    }

    return new osuClasses.LegacyReplayFrame(this.startTime, this.interval, this.position, state);
  }
}

class StandardReplayConverter extends osuClasses.ReplayConverter {
...
class StandardRuleset extends osuClasses.Ruleset {
  get id() {
    return 0;
  }
  applyToBeatmap(beatmap) {
...
exports.SpinnerBonusTick = SpinnerBonusTick;
exports.SpinnerTick = SpinnerTick;
exports.StandardAutopilot = StandardAutopilot;
exports.StandardAutoplay = StandardAutoplay;
exports.StandardBeatmap = StandardBeatmap;
exports.StandardBeatmapConverter = StandardBeatmapConverter;
exports.StandardBeatmapProcessor = StandardBeatmapProcessor;
exports.StandardCinema = StandardCinema;
exports.StandardDifficultyAttributes = StandardDifficultyAttributes;
exports.StandardDifficultyCalculator = StandardDifficultyCalculator;
exports.StandardDifficultyHitObject = StandardDifficultyHitObject;
exports.StandardDoubleTime = StandardDoubleTime;
exports.StandardEasy = StandardEasy;
exports.StandardEventGenerator = StandardEventGenerator;
exports.StandardFlashlight = StandardFlashlight;
exports.StandardHalfTime = StandardHalfTime;
exports.StandardHardRock = StandardHardRock;
exports.StandardHidden = StandardHidden;
exports.StandardHitObject = StandardHitObject;
exports.StandardHitWindows = StandardHitWindows;
exports.StandardModCombination = StandardModCombination;
exports.StandardNightcore = StandardNightcore;
exports.StandardNoFail = StandardNoFail;
exports.StandardNoMod = StandardNoMod;
exports.StandardPerfect = StandardPerfect;
exports.StandardPerformanceAttributes = StandardPerformanceAttributes;
exports.StandardPerformanceCalculator = StandardPerformanceCalculator;
exports.StandardRelax = StandardRelax;
exports.StandardReplayConverter = StandardReplayConverter;
exports.StandardReplayFrame = StandardReplayFrame;
exports.StandardRuleset = StandardRuleset;
exports.StandardSpunOut = StandardSpunOut;
exports.StandardStrainSkill = StandardStrainSkill;
exports.StandardSuddenDeath = StandardSuddenDeath;
exports.StandardTouchDevice = StandardTouchDevice;
