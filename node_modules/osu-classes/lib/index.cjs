...
exports.CompoundType = void 0;

(function(CompoundType) {
  CompoundType['None'] = '';
  CompoundType['Loop'] = 'L';
  CompoundType['Trigger'] = 'T';
})(exports.CompoundType || (exports.CompoundType = {}));
...
})(exports.Origins || (exports.Origins = {}));
...
function getEasingFn(easing) {
  switch (easing) {
    case exports.EasingType.In:
    case exports.EasingType.InQuad: return inQuad;
    case exports.EasingType.Out:
    case exports.EasingType.OutQuad: return outQuad;
    case exports.EasingType.InOutQuad: return inOutQuad;
    case exports.EasingType.InCubic: return inCubic;
    case exports.EasingType.OutCubic: return outCubic;
    case exports.EasingType.InOutCubic: return inOutCubic;
    case exports.EasingType.InQuart: return inQuart;
    case exports.EasingType.OutQuart: return outQuart;
    case exports.EasingType.InOutQuart: return inOutQuart;
    case exports.EasingType.InQuint: return inQuint;
    case exports.EasingType.OutQuint: return outQuint;
    case exports.EasingType.InOutQuint: return inOutQuint;
    case exports.EasingType.InSine: return inSine;
    case exports.EasingType.OutSine: return outSine;
    case exports.EasingType.InOutSine: return inOutSine;
    case exports.EasingType.InExpo: return inExpo;
    case exports.EasingType.OutExpo: return outExpo;
    case exports.EasingType.InOutExpo: return inOutExpo;
    case exports.EasingType.InCirc: return inCirc;
    case exports.EasingType.OutCirc: return outCirc;
    case exports.EasingType.InOutCirc: return inOutCirc;
    case exports.EasingType.InElastic: return inElastic;
    case exports.EasingType.OutElastic: return outElastic;
    case exports.EasingType.OutElasticHalf: return outElasticHalf;
    case exports.EasingType.OutElasticQuarter: return outElasticQuarter;
    case exports.EasingType.InOutElastic: return inOutElastic;
    case exports.EasingType.InBack: return inBack;
    case exports.EasingType.OutBack: return outBack;
    case exports.EasingType.InOutBack: return inOutBack;
    case exports.EasingType.InBounce: return inBounce;
    case exports.EasingType.OutBounce: return outBounce;
    case exports.EasingType.InOutBounce: return inOutBounce;
    case exports.EasingType.OutPow10: return outPow10;
  }
...
class Command {
  constructor(params) {
    ...
    this.type = (_a = params === null || params === void 0 ? void 0 : params.type) !== null && _a !== void 0 ? _a : exports.CommandType.None;
    this.parameter = (_b = params === null || params === void 0 ? void 0 : params.parameter) !== null && _b !== void 0 ? _b : exports.ParameterType.None;
    this.easing = (_c = params === null || params === void 0 ? void 0 : params.easing) !== null && _c !== void 0 ? _c : exports.EasingType.None;
...
class CommandLoop extends CommandTimelineGroup {
  constructor(loopStartTime, loopCount) {
    super();
    this.type = exports.CompoundType.Loop;
...
class CommandTrigger extends CommandTimelineGroup {
  constructor(triggerName, startTime, endTime, groupNumber) {
    super();
    this.type = exports.CompoundType.Trigger;
...
class StoryboardSprite {
  constructor(path, origin, anchor, position) {
    ...
    this.origin = origin !== null && origin !== void 0 ? origin : exports.Origins.TopLeft;
    this.anchor = anchor !== null && anchor !== void 0 ? anchor : exports.Anchor.TopLeft;
  ...
  setValueFromCommand(command, progress) {
    ...
    switch (command.type) {
      case exports.CommandType.Movement:
        this.startPosition.x = value.x;
        this.startPosition.y = value.y;
        break;
      case exports.CommandType.MovementX:
        this.startPosition.x = value;
        break;
      case exports.CommandType.MovementY:
        this.startPosition.y = value;
        break;
      case exports.CommandType.Fade:
        this.color.alpha = value;
        break;
      case exports.CommandType.Scale:
        this.scale.x = value;
        this.scale.y = value;
        break;
      case exports.CommandType.VectorScale:
        this.scale.x = value.x;
        this.scale.y = value.y;
        break;
      case exports.CommandType.Rotation:
        this.rotation = value;
        break;
      case exports.CommandType.Color:
    ...
    if (command.type !== exports.CommandType.Parameter) {
      return;
    }

    switch (command.parameter) {
      case exports.ParameterType.BlendingMode:
        this.isAdditive = value.rgbEquation === 1;
        break;
      case exports.ParameterType.HorizontalFlip:
        this.flipX = value;
        break;
      case exports.ParameterType.VerticalFlip:
        this.flipY = value;
    }
  }
}
...
class StoryboardAnimation extends StoryboardSprite {
  constructor(path, origin, anchor, position, frameCount, frameDelay, loopType) {
    ...
    this.loopType = loopType !== null && loopType !== void 0 ? loopType : exports.LoopType.LoopForever;
  }
}
...
class Storyboard {
  ...
  getLayerByType(type) {
    ...
    return this.getLayerByName((_a = exports.LayerType[type]) !== null && _a !== void 0 ? _a : 'Background');
  }
  getLayerByName(name) {
    let _a;
...
class BeatmapEventSection {
  ...
  get isBackgroundReplaced() {
    ...
    const layer = this.storyboard.getLayerByType(exports.LayerType.Background);
...
})(exports.SampleSet || (exports.SampleSet = {}));
...
class BeatmapGeneralSection {
  constructor() {
    ...
    this.sampleSet = exports.SampleSet.Normal;
...
exports.ControlPointType = void 0;
...
})(exports.ControlPointType || (exports.ControlPointType = {}));

class DifficultyPoint extends ControlPoint {
  constructor() {
    super(...arguments);
    this.pointType = exports.ControlPointType.DifficultyPoint;
...
class EffectPoint extends ControlPoint {
  constructor() {
    super(...arguments);
    this.pointType = exports.ControlPointType.EffectPoint;
    this.kiai = false;
...
class SamplePoint extends ControlPoint {
  constructor() {
    super(...arguments);
    this.pointType = exports.ControlPointType.SamplePoint;
    this.sampleSet = exports.SampleSet[exports.SampleSet.Normal];
    this.customIndex = 0;
    this.volume = 100;
  }
  isRedundant(existing) {
...
})(exports.TimeSignature || (exports.TimeSignature = {}));

class TimingPoint extends ControlPoint {
  constructor() {
    super(...arguments);
    this.pointType = exports.ControlPointType.TimingPoint;
    this._beatLength = 1000;
    this.timeSignature = exports.TimeSignature.SimpleQuadruple;
  }
  get beatLength() {
...
class ControlPointInfo {
  ...
  getCurrentList(newPoint) {
    switch (newPoint.pointType) {
      case exports.ControlPointType.DifficultyPoint: return this.difficultyPoints;
      case exports.ControlPointType.EffectPoint: return this.effectPoints;
      case exports.ControlPointType.SamplePoint: return this.samplePoints;
      case exports.ControlPointType.TimingPoint: return this.timingPoints;
    }
  ...
  checkAlreadyExisting(time, newPoint) {
    ...
    switch (newPoint.pointType) {
      case exports.ControlPointType.DifficultyPoint:
        existing = this.difficultyPointAt(time);
        break;
      case exports.ControlPointType.EffectPoint:
        existing = this.effectPointAt(time);
        break;
      case exports.ControlPointType.SamplePoint:
        existing = findControlPoint(this.samplePoints, time);
        break;
      case exports.ControlPointType.TimingPoint:
...
})(exports.HitSound || (exports.HitSound = {}));
...
})(exports.HitType || (exports.HitType = {}));
...
exports.SliderEventType = void 0;
...
})(exports.SliderEventType || (exports.SliderEventType = {}));
...
class EventGenerator {
  static *generate(slider) {
    ...
    yield {
      eventType: exports.SliderEventType.Head,
    ...
    if (tickDistance !== 0 && tickDistance !== Infinity) {
      for (let spanIndex = 0; spanIndex < slider.spans; ++spanIndex) {
        ...
        while (distance < sliderDistance - minDistanceFromEnd) {
          ...
          events.push({
            eventType: exports.SliderEventType.Tick,
        ...
        if (spanIndex < slider.repeats) {
          yield {
            eventType: exports.SliderEventType.Repeat,
    ...
    yield {
      eventType: exports.SliderEventType.LegacyLastTick,
    ...
    yield {
      eventType: exports.SliderEventType.Tail,
...
class HitWindows {
  ...
  _lowestSuccessfulHitResult() {
    for (let result = exports.HitResult.Meh; result <= exports.HitResult.Perfect; ++result) {
      if (this.isHitResultAllowed(result)) {
        return result;
      }
    }

    return exports.HitResult.None;
  }
  *getAllAvailableWindows() {
    ...
    for (const range of this._getRanges()) {
      ...
      switch (range.result) {
        ...
        case exports.HitResult.Great:
          this._great = value;
          break;
        case exports.HitResult.Perfect:
          this._perfect = value;
          break;
      }
    }
  ...
  resultFor(timeOffset) {
    ...
    for (let result = exports.HitResult.Perfect; result >= exports.HitResult.Miss; --result) {
...
HitWindows._BASE_RANGES = [
  new DifficultyRange(exports.HitResult.Perfect, 22.4, 19.4, 13.9),
  new DifficultyRange(exports.HitResult.Great, 64, 49, 34),
  new DifficultyRange(exports.HitResult.Good, 97, 82, 67),
  new DifficultyRange(exports.HitResult.Ok, 127, 112, 97),
  new DifficultyRange(exports.HitResult.Meh, 151, 136, 121),
  new DifficultyRange(exports.HitResult.Miss, 188, 173, 158),
];
...
_a._ranges = [
  new DifficultyRange(exports.HitResult.Perfect, 0, 0, 0),
  new DifficultyRange(exports.HitResult.Miss, 0, 0, 0),
],
_a);
...
class HitObject {
  constructor() {
    ...
    this.startTime = 0;
    this.hitType = exports.HitType.Normal;
    this.hitSound = exports.HitSound.Normal;
    this.samples = [];
...
class SliderPath {
  constructor(curveType, controlPoints, expectedDistance) {
    ...
    this._curveType = curveType || exports.PathType.Linear;
  ...
  _calculatePath() {
    ...
    for (let i = 0; i < pathPointsLength; ++i) {
      ...
      const segmentType = this.controlPoints[start].type || exports.PathType.Linear;
...
class HitSample {
  constructor() {
    this.sampleSet = exports.SampleSet[exports.SampleSet.None];
    this.hitSound = exports.HitSound[exports.HitSound.Normal];
    this.customIndex = 0;
    this.suffix = '';
    this.volume = 100;
...
class SampleBank {
  constructor() {
    this.filename = '';
    this.volume = 100;
    this.normalSet = exports.SampleSet.Normal;
    this.additionSet = exports.SampleSet.Normal;
    this.customIndex = 0;
  }
  clone() {
...
class Beatmap {
  ...
  get hittable() {
    return this.hitObjects.reduce((s, h) => {
      return s + (h.hitType & exports.HitType.Normal ? 1 : 0);
    }, 0);
  }
  get slidable() {
    return this.hitObjects.reduce((s, h) => {
      return s + (h.hitType & exports.HitType.Slider ? 1 : 0);
    }, 0);
  }
  get spinnable() {
    return this.hitObjects.reduce((s, h) => {
      return s + (h.hitType & exports.HitType.Spinner ? 1 : 0);
    }, 0);
  }
  get holdable() {
    return this.hitObjects.reduce((s, h) => {
      return s + (h.hitType & exports.HitType.Hold ? 1 : 0);
    }, 0);
  }
  clone() {
...
class BeatmapProcessor {
  preProcess(beatmap) {
    ...
    for (let i = 0; i < objectsWithCombo.length; i++) {
      ...
      if (i === 0) {
        objectsWithCombo[i].hitType |= exports.HitType.NewCombo;
...
})(exports.ModBitwise || (exports.ModBitwise = {}));
...
class Autoplay {
  constructor() {
    this.name = 'Autoplay';
    this.acronym = 'AT';
    this.bitwise = exports.ModBitwise.Autoplay;
    this.type = exports.ModType.Automation;
    this.multiplier = 1;
    this.isRanked = false;
    this.incompatibles = exports.ModBitwise.NoFail |
            exports.ModBitwise.SuddenDeath |
            exports.ModBitwise.Perfect |
            exports.ModBitwise.Relax |
            exports.ModBitwise.Relax2 |
            exports.ModBitwise.SpunOut |
            exports.ModBitwise.Cinema;
  }
}
...
class Cinema {
  constructor() {
    this.name = 'Cinema';
    this.acronym = 'CN';
    this.bitwise = exports.ModBitwise.Cinema;
    this.type = exports.ModType.Fun;
    this.multiplier = 1;
    this.isRanked = false;
    this.incompatibles = exports.ModBitwise.NoFail |
            exports.ModBitwise.SuddenDeath |
...
class DoubleTime {
  constructor() {
    ...
    this.acronym = 'DT';
    this.bitwise = exports.ModBitwise.DoubleTime;
    this.type = exports.ModType.DifficultyIncrease;
    this.multiplier = 1.12;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.HalfTime | exports.ModBitwise.Nightcore;
  }
...
class Easy {
  constructor() {
    this.name = 'Easy';
    this.acronym = 'EZ';
    this.bitwise = exports.ModBitwise.Easy;
    this.type = exports.ModType.DifficultyReduction;
    this.multiplier = 0.5;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.HardRock;
  }
  applyToDifficulty(difficulty) {
...
class Flashlight {
  constructor() {
    ...
    this.acronym = 'FL';
    this.bitwise = exports.ModBitwise.Flashlight;
    this.type = exports.ModType.DifficultyIncrease;
    this.multiplier = 1.12;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.None;
  }
}
...
class HalfTime {
  constructor() {
    this.name = 'Half Time';
    this.acronym = 'HT';
    this.bitwise = exports.ModBitwise.HalfTime;
    this.type = exports.ModType.DifficultyReduction;
    this.multiplier = 0.3;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.DoubleTime | exports.ModBitwise.Nightcore;
  }
  applyToDifficulty(difficulty) {
...
class HardRock {
  constructor() {
    this.name = 'Hard Rock';
    this.acronym = 'HR';
    this.bitwise = exports.ModBitwise.HardRock;
    this.type = exports.ModType.DifficultyIncrease;
    this.multiplier = 1.06;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.Easy;
  }
  applyToDifficulty(difficulty) {
...
class Hidden {
  constructor() {
    this.name = 'Hidden';
    this.acronym = 'HD';
    this.bitwise = exports.ModBitwise.Hidden;
    this.type = exports.ModType.DifficultyIncrease;
    this.multiplier = 1.06;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.None;
...
class Nightcore extends DoubleTime {
  constructor() {
    ...
    this.name = 'Nightcore';
    this.acronym = 'NC';
    this.bitwise = exports.ModBitwise.Nightcore;
    this.incompatibles = exports.ModBitwise.HalfTime | exports.ModBitwise.DoubleTime;
  }
}
...
class NoFail {
  constructor() {
    this.name = 'No Fail';
    this.acronym = 'NF';
    this.bitwise = exports.ModBitwise.NoFail;
    this.type = exports.ModType.DifficultyReduction;
    this.multiplier = 0.5;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.SuddenDeath |
            exports.ModBitwise.Perfect |
            exports.ModBitwise.Autoplay |
            exports.ModBitwise.Cinema |
            exports.ModBitwise.Relax |
...
class NoMod {
  constructor() {
    this.name = 'No Mod';
    this.acronym = 'NM';
    this.bitwise = exports.ModBitwise.None;
    this.type = exports.ModType.System;
    this.multiplier = 1;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.None;
  }
...
class Perfect {
  constructor() {
    this.name = 'Perfect';
    this.acronym = 'PF';
    this.bitwise = exports.ModBitwise.Perfect;
    this.type = exports.ModType.DifficultyIncrease;
    this.multiplier = 1;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.NoFail |
...
class Relax {
  constructor() {
    this.name = 'Relax';
    this.acronym = 'RX';
    this.bitwise = exports.ModBitwise.Relax;
    this.type = exports.ModType.Automation;
    this.multiplier = 1;
    this.isRanked = false;
    this.incompatibles = exports.ModBitwise.NoFail |
...
class SuddenDeath {
  constructor() {
    ...
    this.acronym = 'SD';
    this.bitwise = exports.ModBitwise.SuddenDeath;
    this.type = exports.ModType.DifficultyIncrease;
    this.multiplier = 1;
    this.isRanked = true;
    this.incompatibles = exports.ModBitwise.NoFail |
...
class ModCombination {
  ...
  get bitwise() {
    return this.all.reduce((bitwise, mod) => {
      ...
      if (mod.bitwise === exports.ModBitwise.Nightcore) {
        bitwise |= exports.ModBitwise.DoubleTime;
      }

      if (mod.bitwise === exports.ModBitwise.Perfect) {
        bitwise |= exports.ModBitwise.SuddenDeath;
      }
...
exports.ReplayButtonState = void 0;
...
})(exports.ReplayButtonState || (exports.ReplayButtonState = {}));
...
class LegacyReplayFrame extends ReplayFrame {
  constructor(startTime, interval, position, buttonState) {
    ...
    this.buttonState = buttonState !== null && buttonState !== void 0 ? buttonState : exports.ReplayButtonState.None;
  }
  get mouseX() {
  ...
  get mouseLeft1() {
    return (this.buttonState & exports.ReplayButtonState.Left1) > 0;
  }
  get mouseRight1() {
    return (this.buttonState & exports.ReplayButtonState.Right1) > 0;
  }
  get mouseLeft2() {
    return (this.buttonState & exports.ReplayButtonState.Left2) > 0;
  }
  get mouseRight2() {
    return (this.buttonState & exports.ReplayButtonState.Right2) > 0;
  }
  get smoke() {
    return (this.buttonState & exports.ReplayButtonState.Smoke) > 0;
  }
  clone() {
    const cloned = super.clone();
...
})(exports.ScoreRank || (exports.ScoreRank = {}));
...
class HitStatistics extends Map {
  ...
  static _getJsonableKeyFromHitResult(result) {
    switch (result) {
      case exports.HitResult.None: return 'none';
      case exports.HitResult.Miss: return 'miss';
      case exports.HitResult.Meh: return 'meh';
      case exports.HitResult.Ok: return 'ok';
      case exports.HitResult.Good: return 'good';
      case exports.HitResult.Great: return 'great';
      case exports.HitResult.Perfect: return 'perfect';
      case exports.HitResult.SmallTickMiss: return 'smallTickMiss';
      case exports.HitResult.SmallTickHit: return 'smallTickHit';
      case exports.HitResult.LargeTickMiss: return 'largeTickMiss';
      case exports.HitResult.LargeTickHit: return 'largeTickHit';
      case exports.HitResult.SmallBonus: return 'smallBonus';
      case exports.HitResult.LargeBonus: return 'largeBonus';
      case exports.HitResult.IgnoreMiss: return 'ignoreMiss';
      case exports.HitResult.IgnoreHit: return 'ignoreHit';
    }
  }
  static _getHitResultFromJsonableKey(key) {
    switch (key) {
      case 'none': return exports.HitResult.None;
      case 'miss': return exports.HitResult.Miss;
      case 'meh': return exports.HitResult.Meh;
      case 'ok': return exports.HitResult.Ok;
      case 'good': return exports.HitResult.Good;
      case 'great': return exports.HitResult.Great;
      case 'perfect': return exports.HitResult.Perfect;
      case 'smallTickMiss': return exports.HitResult.SmallTickMiss;
      case 'smallTickHit': return exports.HitResult.SmallTickHit;
      case 'largeTickMiss': return exports.HitResult.LargeTickMiss;
      case 'largeTickHit': return exports.HitResult.LargeTickHit;
      case 'smallBonus': return exports.HitResult.SmallBonus;
      case 'largeBonus': return exports.HitResult.LargeBonus;
      case 'ignoreMiss': return exports.HitResult.IgnoreMiss;
      case 'ignoreHit': return exports.HitResult.IgnoreHit;
    }
  }
}
...
class LegacyScoreExtensions {
  ...
  get countGeki() {
    if (this.rulesetId === 3) {
      return this.statistics.has(exports.HitResult.Perfect)
        ? this.statistics.get(exports.HitResult.Perfect)
  ...
  set countGeki(value) {
    ...
    if (this.rulesetId === 3) {
      this.statistics.set(exports.HitResult.Perfect, value);
    }

    this._legacyCountGeki = value;
  }
  get count300() {
    return this.statistics.get(exports.HitResult.Great);
  }
  set count300(value) {
    if (!this.statistics) {
      return;
    ...
    this.statistics.set(exports.HitResult.Great, value);
  }
  get countKatu() {
    if (this.rulesetId === 2) {
      return this.statistics.has(exports.HitResult.SmallTickMiss)
        ? this.statistics.get(exports.HitResult.SmallTickMiss)
        : this._legacyCountKatu;
    }

    if (this.rulesetId === 3) {
      return this.statistics.has(exports.HitResult.Good)
        ? this.statistics.get(exports.HitResult.Good)
        : this._legacyCountKatu;
    }
  ...
  set countKatu(value) {
    ...
    if (this.rulesetId === 2) {
      this.statistics.set(exports.HitResult.SmallTickMiss, value);
    }

    if (this.rulesetId === 3) {
      this.statistics.set(exports.HitResult.Good, value);
    }
  ...
  get count100() {
    if (this.rulesetId === 2) {
      return this.statistics.get(exports.HitResult.LargeTickHit);
    }

    return this.statistics.get(exports.HitResult.Ok);
  }
  set count100(value) {
    if (!this.statistics) {
      return;
    ...
    if (this.rulesetId === 2) {
      this.statistics.set(exports.HitResult.LargeTickHit, value);
    }

    this.statistics.set(exports.HitResult.Ok, value);
  }
  get count50() {
    if (this.rulesetId === 2) {
      return this.statistics.get(exports.HitResult.SmallTickHit);
    }

    return this.statistics.get(exports.HitResult.Meh);
  }
  set count50(value) {
    if (!this.statistics) {
      return;
    ...
    if (this.rulesetId === 2) {
      this.statistics.set(exports.HitResult.SmallTickHit, value);
    }

    this.statistics.set(exports.HitResult.Meh, value);
  }
  get countMiss() {
    return this.statistics.get(exports.HitResult.Miss);
  }
  set countMiss(value) {
    if (!this.statistics) {
      return;
    ...
    this.statistics.set(exports.HitResult.Miss, value);
  }
  get totalHits() {
...
function shouldBeSilverRank(scoreInfo) {
  ...
  if (typeof scoreInfo.rawMods === 'number') {
    const hasHidden = (scoreInfo.rawMods & exports.ModBitwise.Hidden) > 0;
    const hasFlashlight = (scoreInfo.rawMods & exports.ModBitwise.Flashlight) > 0;
...
exports.BeatmapBreakEvent = BeatmapBreakEvent;
exports.BeatmapColorSection = BeatmapColorSection;
exports.BeatmapConverter = BeatmapConverter;
exports.BeatmapDifficultySection = BeatmapDifficultySection;
exports.BeatmapEditorSection = BeatmapEditorSection;
exports.BeatmapEventSection = BeatmapEventSection;
exports.BeatmapGeneralSection = BeatmapGeneralSection;
exports.BeatmapInfo = BeatmapInfo;
exports.BeatmapMetadataSection = BeatmapMetadataSection;
exports.BeatmapProcessor = BeatmapProcessor;
exports.BinarySearch = BinarySearch;
exports.BlendingParameters = BlendingParameters;
exports.Cinema = Cinema;
exports.CircularArcProperties = CircularArcProperties;
...
exports.DifficultyPoint = DifficultyPoint;
exports.DifficultyRange = DifficultyRange;
exports.DoubleTime = DoubleTime;
exports.Easing = Easing;
exports.Easy = Easy;
exports.EffectPoint = EffectPoint;
exports.EventGenerator = EventGenerator;
exports.FastRandom = FastRandom;
exports.Flashlight = Flashlight;
exports.Grades = Grades;
exports.HalfTime = HalfTime;
exports.HardRock = HardRock;
exports.Hidden = Hidden;
exports.HighestRank = HighestRank;
exports.HitObject = HitObject;
exports.HitSample = HitSample;
exports.HitStatistics = HitStatistics;
exports.HitWindows = HitWindows;
exports.Interpolation = Interpolation;
exports.LegacyReplayFrame = LegacyReplayFrame;
exports.LegacyScoreExtensions = LegacyScoreExtensions;
exports.LevelInfo = LevelInfo;
exports.LifeBarFrame = LifeBarFrame;
exports.LimitedCapacityQueue = LimitedCapacityQueue;
exports.MathUtils = MathUtils;
exports.ModCombination = ModCombination;
exports.Nightcore = Nightcore;
exports.NoFail = NoFail;
exports.NoMod = NoMod;
exports.PathApproximator = PathApproximator;
exports.PathPoint = PathPoint;
exports.Perfect = Perfect;
exports.PerformanceAttributes = PerformanceAttributes;
exports.PerformanceCalculator = PerformanceCalculator;
exports.ProgressiveCalculationBeatmap = ProgressiveCalculationBeatmap;
exports.Rank = Rank;
exports.RankHistory = RankHistory;
exports.Relax = Relax;
exports.Replay = Replay;
exports.ReplayConverter = ReplayConverter;
exports.ReplayFrame = ReplayFrame;
exports.ReverseQueue = ReverseQueue;
exports.RoundHelper = RoundHelper;
exports.Ruleset = Ruleset;
exports.RulesetBeatmap = RulesetBeatmap;
exports.SampleBank = SampleBank;
exports.SamplePoint = SamplePoint;
exports.Score = Score;
...
exports.StoryboardVideo = StoryboardVideo;
exports.StrainDecaySkill = StrainDecaySkill;
exports.StrainSkill = StrainSkill;
exports.SuddenDeath = SuddenDeath;
exports.TimedDifficultyAttributes = TimedDifficultyAttributes;
